...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Buat Data " ?>  Hewan Adopsi</h3>
	</div>
	<div class="card-body">
		<form action="" id="inventory-form">
			<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
			<div class="form-group">
				<label for="product_id" class="control-label">Nama Hewan</label>
            ...
            <div class="form-group">
				<label for="size" class="control-label">Jenis Kelamin</label>
            ...
            <div class="form-group">
				<label for="quantity" class="control-label">Alamat</label>
                <input type="text" class="form-control form" required name="quantity" value="<?php echo isset($quantity) ? $quantity : '' ?>">
            </div>
            <div class="form-group">
				<label for="price" class="control-label">Umur</label>
                <input type="text" step="any" class="form-control form" required name="price" value="<?php echo isset($price) ? $price : '' ?>">
            </div>
		</form>
	</div>
