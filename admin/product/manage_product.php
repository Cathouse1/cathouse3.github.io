...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Tambah Jenis " ?> Hewan</h3>
	</div>
	<div class="card-body">
		<form action="" id="product-form">
            ...
            <div class="form-group">
				<label for="sub_category_id" class="control-label">Jenis Hewan</label>
			...
			<div class="form-group">
				<label for="product_name" class="control-label">Nama</label>
            ...
            <div class="form-group">
				...
				<div class="custom-file">
	              ...
	              <label class="custom-file-label" for="customFile">Tambah Foto</label>
	            </div>
			</div>
            <?php 
            if(isset($id)):
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="product-form">Simpan</button>
		<a class="btn btn-flat btn-default" href="?page=product">Batal</a>
	</div>
</div>
<script>
	...
	$(document).ready(function(){
        ...
        $('#category_id').change(function(){
            ...
            $('#sub_category_id').select2({placeholder:"Silahkan Pilih Disini",width:"relative"})
        })
        $('.select2').select2({placeholder:"Silahkan Pilih Disini",width:"relative"})
