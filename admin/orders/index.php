					...
					?>
						<tr>
							...
							<td class="text-center">
                                <?php if($row['status'] == 0): ?>
                                    <span class="badge badge-light">Ditunda</span>
                                <?php elseif($row['status'] == 1): ?>
                                    <span class="badge badge-primary">Disiapkan</span>
								<?php elseif($row['status'] == 2): ?>
                                    <span class="badge badge-warning">Keluar Untuk Pengumpulan</span>
							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item" href="?page=orders/view_order&id=<?php echo $row['id'] ?>">Lihat Data Adopsi</a>
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Apakah Kamu Yakin Ingin Menghapusnya?","delete_order",[$(this).attr('data-id')])
		})
