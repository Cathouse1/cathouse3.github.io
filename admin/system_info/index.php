...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		...
		<div class="card-body">
			...
			<div class="form-group">
				<label for="" class="control-label">Edukasi</label>
	             <textarea name="edukasi" id="" cols="30" rows="2" class="form-control summernote"><?php echo  is_file(base_app.'edukasi.html') ? file_get_contents(base_app.'edukasi.html') : "" ?></textarea>
			</div>
			<div class="form-group">
				<label for="" class="control-label">Artikel</label>
	             <textarea name="artikel" id="" cols="30" rows="2" class="form-control summernote"><?php echo  is_file(base_app.'artikel.html') ? file_get_contents(base_app.'artikel.html') : "" ?></textarea>
			</div>
			<div class="form-group">
