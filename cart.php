    ...
    <div class="container">
        <div class="row">
            <div class="col d-flex justify-content-end mb-2">
                <button class="btn btn-outline-dark btn-flat btn-sm" type="button" id="empty_cart">Hapus Semua</button>
            </div>
        </div>
                ...
                ?>
                    <div class="d-flex w-100 justify-content-between  mb-2 py-2 border-bottom cart-item">
                        <div class="d-flex align-items-center col-8">
                            ...
                            <div>
                                <b><p class="mb-1 mb-sm-1"><?php echo $row['product_name'] ?></p></b>
                                <p class="mb-1 mb-sm-1"><small>Jenis Kelamin : <?php echo $row['size'] ?></small></p>
                                <p class="mb-1 mb-sm-1"><small>Umur : <span class="price"><?php echo ($row['price']) ?></span></small></p>
                                <div>
        ...
        <div class="d-flex w-100 justify-content-end">
            <a href="./?p=checkout" class="btn btn-sm btn-flat btn-dark">Selanjutnya</a>
        </div>
    </div>
</section>
<script>
