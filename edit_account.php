        ...
        <div class="card rounded-0">
            <div class="card-body">
                <div class="w-100 justify-content-between d-flex">
                    <h4><b>Perbarui Detail Akun</b></h4>
                    <a href="./?p=my_account" class="btn btn btn-dark btn-flat"><div class="fa fa-angle-left"></div> Kembali</a>
                </div>
                        ...
                        <input type="hidden" name="id" value="<?php echo $_settings->userdata('id') ?>">
                            ...
                            <div class="form-group">
                                ...
                                <select name="gender" id="" class="custom-select select" required>
                                    <option <?php echo $_settings->userdata('gender') == "Male" ? "selected" : '' ?>>Perempuan</option>
                                    <option <?php echo $_settings->userdata('gender') == "Female" ? "selected" : '' ?>>Laki-Laki</option>
                                </select>
                            </div>
                            <div class="form-group">
            ...
            $.ajax({
                ...
                success:function(resp){
                    if(typeof resp == 'object' && resp.status == 'success'){
                        alert_toast("Akun Berhasil Diperbaharui",'success');
                        $('#update_account [name="password"],#update_account [name="cpassword"]').attr('required',false);
