        ...
        <div class="card rounded-0">
            <div class="card-body">
                <div class="w-100 justify-content-between d-flex">
                    <h4><b>Adopsi</b></h4>
                    <a href="./?p=edit_account" class="btn btn btn-dark btn-flat"><div class="fa fa-user-cog"></div> Kelola Akun</a>
                </div>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                            <?php if($row['status'] == 0): ?>
                                                <span class="badge badge-light text-dark">Tertunda</span>
                                            <?php elseif($row['status'] == 1): ?>
                                                <span class="badge badge-primary">Disiapkan</span>
                                            <?php elseif($row['status'] == 2): ?>
                                                <span class="badge badge-warning">Keluar Untuk Pengiriman</span>
                                            <?php elseif($row['status'] == 3): ?>
                                                <span class="badge badge-success">Terkirim</span>
                                            <?php else: ?>
                                                <span class="badge badge-danger">Dibatallkan</span>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                            <?php endwhile; ?>
...
<script>
    ...
    $(function(){
        $('.view_order').click(function(){
            uni_modal("Detai Adopsi","./admin/orders/view_order.php?view=user&id="+$(this).attr('data-id'),'large')
        })
        $('table').dataTable();
