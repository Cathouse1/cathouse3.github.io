            ...
            <div class="container px-4 px-lg-5 ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        s&c=<?php echo md5($crow['id']) ?>"><?php echo $crow['category'] ?></a></li>
                        ...
                        <li class="nav-item"><a class="nav-link" href="./?p=about">About</a></li>
                         <li class="nav-item"><a class="nav-link" href="./?p=artikel">Artikel</a></li>
                          <li class="nav-item"><a class="nav-link" href="./?p=edukasi">Edukasi</a></li>
                    </ul>
