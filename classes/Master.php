...
Class Master extends DBConnection {
	...
	function save_inventory(){
		...
		if($save){
			$resp['status'] = 'success';
			if(empty($id))
				$this->settings->set_flashdata('success',"Data Baru Berhasil Ditambahkan.");
			else
				$this->settings->set_flashdata('success',"Data Berhasil Ditambahkan.");
		}else{
			$resp['status'] = 'failed';
			$resp['err'] = $this->conn->error."[{$sql}]";
		}
	...
	function delete_order(){
		...
		if($delete){
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success',"Data Berhasil Diubah");
		}else{
			$resp['status'] = 'failed';
			$resp['err'] = $this->conn->error."[{$sql}]";
		}
	...
	function update_order_status(){
		...
		if($update){
			$resp['status'] ='success';
			$this->settings->set_flashdata("success"," Status Berhasil Diubah");
		}else{
			$resp['status'] ='failed';
