    ...
    <div class="container px-4 px-lg-5 my-5">
        <div class="row gx-4 gx-lg-5 align-items-center">
            ...
            <div class="col-md-6">
                ...
                <div class="fs-5 mb-5">
               Umur Hewan : <span id="price"><?php echo $inv[0]['price'] ?></span>
                <br>
                <span><small>Lokasi : <span id="avail"><?php echo $inv[0]['quantity'] ?></span></small></span>
                </div>
                <div class="fs-5 mb-5 ">Jenis Kelamin : 
                    <?php foreach($inv as $k => $v): ?>
                        <span><button class="btn btn-sm  <?php echo $k == 0 ? "active":'' ?>" data-id="<?php echo $k ?>"><?php echo $v['size'] ?></button></span>
                    <?php endforeach; ?>
                </div>
...
<section class="py-5 bg-light">
    <div class="container px-4 px-lg-5 mt-5">
        <h2 class="fw-bolder mb-4">Hewan Lainnya</h2>
            ...
            <div class="col mb-5">
                <div class="card h-100 product-item">
                    ...
                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        <div class="text-center">
                            <a class="btn btn-flat btn-primary "   href=".?p=view_product&id=<?php echo md5($row['id']) ?>">Lihat</a>
                        </div>
    ...
    $(function(){
        ...
        $('#add-cart').submit(function(e){
            ...
            $.ajax({
                ...
                error:err=>{
                    console.log(err)
                    alert_toast("Gagal Menambahkan",'error')
                    end_loader()
                },
                success:function(resp){
                    if(typeof resp == 'object' && resp.status=='success'){
                        alert_toast("Hewan Berhasil Ditambahkan.",'success')
