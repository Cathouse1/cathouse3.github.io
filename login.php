        ...
        <div class="col-lg-12">
            ...
            <form action="" id="login-form">
                ...
                <div class="form-group d-flex justify-content-between">
                    <a href="javascript:void()" id="create_account">Buat Akun</a>
                     <div><a href="Admin/login.php">Masuk Sebagai Admin</a></div>
            ...
            $.ajax({
                ...
                success:function(resp){
                    if(typeof resp == 'object' && resp.status == 'success'){
                        alert_toast("Berhasil Login",'success')
                        setTimeout(function(){
                            location.reload()
                        },2000)
